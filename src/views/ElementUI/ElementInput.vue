    ...
    <div class="card-body">
      ...
      <div class="row">
        <div class="col-md-4">
          ...
          <!--Both prefix & suffix Icon-->
          <InputField
            v-model="input.both_icon"
            rules="required"
            vid="vid"
            size="medium"
            class="mb-3"
